...
function cargarPregunta() {
    ...
    if (estadoPreguntas.indexOf(0) >= 0) {
        //Controlo que todavía hallan preguntas por contestar
        ...
        document.getElementById("letra-pregunta").textContent =
            bd_juego[numPreguntaActual].id;
        document.getElementById("pregunta").textContent =
            bd_juego[numPreguntaActual].pregunta;
...
function mostrarPantallaFinal() {
    ...
    document.getElementById("score").textContent =
        (cantidadAcertadas * 100) / 10 + "% de acierto";
